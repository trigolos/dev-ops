...
describe('BasicAuthInterceptor', () => {
  ...
  it(
    'should add auth headers to request',
    waitForAsync(
      inject([HttpClient, AuthService], (http, authService) => {
  ...
  it(
    'should not add auth headers to request',
    waitForAsync(
      inject([HttpClient, AuthService], (http, authService) => {
  ...
  it(
    'should not add auth headers to request based on env setting',
    waitForAsync(
      inject([HttpClient, AuthService], (http, authService) => {
