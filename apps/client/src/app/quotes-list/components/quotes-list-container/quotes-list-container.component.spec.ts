  ...
  beforeEach(
    waitForAsync(() => {
      TestBed.configureTestingModule({
        declarations: [QuotesListContainerComponent, QuotesListTableComponent, LoaderComponent, TableComponent],
        imports: [HttpClientTestingModule, RouterTestingModule],
        providers: [mockNgxSmartModalService, mockToastrServiceProvider],
      }).compileComponents();
    }),
  );
