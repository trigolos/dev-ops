...
const COMPONENTS = [QuotesListContainerComponent, QuotesListTableComponent, DeleteQuoteModalComponent];

@NgModule({
  declarations: [...COMPONENTS],
  imports: [CommonModule, SharedModule, QuotesListRoutingModule],
})
