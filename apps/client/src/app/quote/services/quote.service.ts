...
export class QuoteService {
  ...
  constructor(private quotesApi: QuoteApiService, @Inject(QUOTESY) private quotes: any) {}

  getRandom(): Observable<Quote> {
    return (this.hasApiUrl ? this.quotesApi.getRandom() : of(this.quotes.random())).pipe(
